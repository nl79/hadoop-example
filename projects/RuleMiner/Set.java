...
public class Set implements Comparable<Set> {
  ...
  public Set(List<Integer> items, int supportCount) {
    super();
    this.items = items;
  ...
  public String toString() {
    return "Set [items=" + Arrays.toString(items.toArray()) + ", supportCount=" + supportCount + "]";
  }


  // Two Sets are equal if they have the same set of items.
